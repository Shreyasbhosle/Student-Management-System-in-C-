...
public: // public variables
 ...
 cout << "\nClass of the Student: " << " " << clss;
 cout << "\nDate of birth of the Student: " << " " << date_of_birth;
 cout << "\nMobile Number of the Student: "<< " " << mobile << endl;
 }
...
public: // public variables of Base class II
 ...
 {
 cout << "------------------------------------------------------------ ";
 cout << "\nStudent's sport marks is(out of 100) : "<< " " << sport << endl;
 cout << "Student's yoga marks is(out of 100) : " << " " << yoga << endl;
 cout << "Student's music marks is(out of 100) : "<< " " << music << endl;
 cout << "Student's photo marks is(out of 100) : "<< " " << photo << endl;
 }
};
...
public: // public functions of child class
 ...
 cout << "\nTotal marks of the student in extra curricular activities (out of 400): " << sum(sport, yoga, music, photo) << 
endl;
 cout<<"\n Total score obtained by student are :"<<(((sum(physics, chemistry, maths)/3)*0.7) +((sum(sport, yoga, 
music, photo)/4)*0.3))<<endl;
 }
 void total_marks()
 {
